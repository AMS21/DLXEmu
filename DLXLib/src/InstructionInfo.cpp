...
namespace dlx
{
    ...
    {
        PHI_DBG_ASSERT(m_Executor, "No execution function defined");

        // Make sure non arguments are marked as unknown
        PHI_DBG_ASSERT(arg1.GetType() != ArgumentType::Unknown, "Arg1 type is unknown");
        PHI_DBG_ASSERT(arg2.GetType() != ArgumentType::Unknown, "Arg2 type is unknown");
        PHI_DBG_ASSERT(arg3.GetType() != ArgumentType::Unknown, "Arg3 type is unknown");

        // Make sure argument types match
        PHI_DBG_ASSERT(ArgumentTypeIncludes(arg1.GetType(), m_Arg1Type),
                       "Unexpected argument type for arg1");
        PHI_DBG_ASSERT(ArgumentTypeIncludes(arg2.GetType(), m_Arg2Type),
                       "Unexpected argument type for arg2");
        PHI_DBG_ASSERT(ArgumentTypeIncludes(arg3.GetType(), m_Arg3Type),
