...
constexpr InstructionTableT InitializeIntructionTable() noexcept
{
    ...
    InitInstruction(table, OpCode::ADDF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::FloatRegister, RegisterAccessType::Float, impl::ADDF);
    InitInstruction(table, OpCode::ADDD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::SUBF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::FloatRegister, RegisterAccessType::Float, impl::SUBF);
    InitInstruction(table, OpCode::SUBD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::MULTF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::FloatRegister, RegisterAccessType::Float, impl::MULTF);
    InitInstruction(table, OpCode::MULTD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::DIVF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::FloatRegister, RegisterAccessType::Float, impl::DIVF);
    InitInstruction(table, OpCode::DIVD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::LTF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::LTF);
    InitInstruction(table, OpCode::LTD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::GTF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::GTF);
    InitInstruction(table, OpCode::GTD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::LEF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::LEF);
    InitInstruction(table, OpCode::LED, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::GEF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::GEF);
    InitInstruction(table, OpCode::GED, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::EQF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::EQF);
    InitInstruction(table, OpCode::EQD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    InitInstruction(table, OpCode::NEF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::NEF);
    InitInstruction(table, OpCode::NED, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    // Jump
    InitInstruction(table, OpCode::J, ArgumentType::Label, ArgumentType::None, ArgumentType::None,
    ...
    // Jump and link
    InitInstruction(table, OpCode::JAL, ArgumentType::Label, ArgumentType::None, ArgumentType::None,
    ...
    // Load high immediate
    InitInstruction(table, OpCode::LHI, ArgumentType::IntRegister, ArgumentType::ImmediateInteger,
    ...
    // Store byte
    InitInstruction(
            table, OpCode::SB, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::IntRegister, ArgumentType::None, RegisterAccessType::Signed, impl::SB);

    // Store byte unsigned
    InitInstruction(
            table, OpCode::SBU, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::IntRegister, ArgumentType::None, RegisterAccessType::Unsigned, impl::SBU);

    // Store half word
    InitInstruction(
            table, OpCode::SH, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::IntRegister, ArgumentType::None, RegisterAccessType::Signed, impl::SH);

    // Store half word unsigned
    InitInstruction(
            table, OpCode::SHU, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::IntRegister, ArgumentType::None, RegisterAccessType::Unsigned, impl::SHU);

    // Store word
    InitInstruction(
            table, OpCode::SW, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::IntRegister, ArgumentType::None, RegisterAccessType::Signed, impl::SW);

    // Store word unsigned
    InitInstruction(
            table, OpCode::SWU, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::IntRegister, ArgumentType::None, RegisterAccessType::Unsigned, impl::SWU);

    // Store float
    InitInstruction(
            table, OpCode::SF, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::FloatRegister, ArgumentType::None, RegisterAccessType::Float, impl::SF);

    // Store double
    InitInstruction(
            table, OpCode::SD, ArgumentType::ImmediateInteger | ArgumentType::AddressDisplacement,
            ArgumentType::FloatRegister, ArgumentType::None, RegisterAccessType::Double, impl::SD);

    /* Moving data */

    // Move float
    InitInstruction(table, OpCode::MOVF, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::MOVF);

    // Move double
    InitInstruction(table, OpCode::MOVD, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Double, impl::MOVD);

    // Move float to int
    InitInstruction(table, OpCode::MOVFP2I, ArgumentType::IntRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::MOVFP2I);

    // Move int to float
    InitInstruction(table, OpCode::MOVI2FP, ArgumentType::FloatRegister, ArgumentType::IntRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::MOVI2FP);

    /* Converting data */

    // Convert float to double
    InitInstruction(table, OpCode::CVTF2D, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::MixedFloatDouble, impl::CVTF2D);

    // Convert float to int
    InitInstruction(table, OpCode::CVTF2I, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::CVTF2I);

    // Convert double to float
    InitInstruction(table, OpCode::CVTD2F, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::MixedFloatDouble, impl::CVTD2F);

    // Convert double to int
    InitInstruction(table, OpCode::CVTD2I, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::MixedFloatDouble, impl::CVTD2I);

    // Convert int to float
    InitInstruction(table, OpCode::CVTI2F, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
                    ArgumentType::None, RegisterAccessType::Float, impl::CVTI2F);

    // Convert int to double
    InitInstruction(table, OpCode::CVTI2D, ArgumentType::FloatRegister, ArgumentType::FloatRegister,
    ...
    // Halt
    InitInstruction(table, OpCode::HALT, ArgumentType::None, ArgumentType::None, ArgumentType::None,
                    RegisterAccessType::None, impl::HALT);

    // No operation
    InitInstruction(table, OpCode::NOP, ArgumentType::None, ArgumentType::None, ArgumentType::None,
