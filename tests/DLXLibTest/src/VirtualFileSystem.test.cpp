...
TEST_CASE("VirtualFileSystem")
{
    ...
    SECTION("VirtualFileSystem()")
    {
        ...
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 0u);
        CHECK(vfs.IsEmpty());

        CHECK(vfs.GetFileHandleLimit().unsafe() == dlx::DefaultFileHandleLimit);
    }
    ...
    SECTION("CreateVirtualFile")
    {
        ...
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 1u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 1u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        ...
        CHECK_FALSE(vfs.IsEmpty());
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 2u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 2u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        ...
        CHECK_FALSE(vfs.IsEmpty());
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 3u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 2u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 1u);
    ...
    SECTION("LinkFile")
    {
        ...
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 2u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 2u);
    ...
    SECTION("Clear")
    {
        ...
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 5u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 2u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 3u);
    ...
    SECTION("SetFileHandleLimit")
    {
        ...
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 5u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 5u);

        // Higher than before
        vfs.SetFileHandleLimit(dlx::DefaultFileHandleLimit + 10u);
        CHECK(vfs.GetFileHandleLimit().unsafe() == dlx::DefaultFileHandleLimit + 10u);
        CHECK_FALSE(vfs.IsEmpty());
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 5u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 5u);
        ...
        CHECK(vfs.GetFileHandleLimit().unsafe() == 6u);
        CHECK_FALSE(vfs.IsEmpty());
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 5u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 5u);
        ...
        CHECK_FALSE(vfs.IsEmpty());
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 6u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 6u);
        ...
        vfs.SetFileHandleLimit(3u);
        CHECK(vfs.GetFileHandleLimit().unsafe() == 3u);
        CHECK_FALSE(vfs.IsEmpty());
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 3u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 3u);
        ...
        CHECK(vfs.GetFileHandleLimit().unsafe() == 0u);
        CHECK(vfs.IsEmpty());
        CHECK(vfs.GetNumberOfFileHandles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfLinkedFiles().unsafe() == 0u);
        CHECK(vfs.CountNumberOfVirtualFiles().unsafe() == 0u);
